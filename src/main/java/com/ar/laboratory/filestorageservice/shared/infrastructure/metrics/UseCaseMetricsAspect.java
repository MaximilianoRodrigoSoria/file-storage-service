package com.ar.laboratory.filestorageservice.shared.infrastructure.metrics;
...
public class UseCaseMetricsAspect {
     ...
     */
    @Around(
            "execution(* com.ar.laboratory.filestorageservice..application.inbound.command..*(..))"
                    + " && !within(com.ar.laboratory.filestorageservice..infrastructure..*)")
